...
two people ten thousand miles away can interact with each other over
...
except this time with Big Tech companies playing the role of
banks &mdash; and right now Apple, Google, and Facebook are being
dragged through the court systems of every major jurisdiction on Earth.
...
**increasing opportunity** on the Internet.
...
also creating **concrete incentives** for participating in and 
enriching the network.

## Why should I care about the problem you're trying to solve?
If you care about effective and unintrusive security for yourself and
...
[whitepaper](https://interlock-network.github.io/interlock-whitepaper/whitepaper/) 
and [Github](https://github.com/interlock-network) for implementation
details.
...
channel for [announcements](https://t.me/interlockann) and 
[chat](https://t.me/interlockchat), a [Twitter](https://twitter.com/interlockweb3) 
account, and a [GitHub](https://github.com/interlock-network) account. 
We may add more venues for discussions in the future.
